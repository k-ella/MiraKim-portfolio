...
--Make sample dataset for GitHub repository
CREATE TABLE canada_labour_market_sample_data
AS SELECT * FROM canada_labour_market
ORDER BY RANDOM()
LIMIT 100;

COPY canada_labour_market_sample_data
TO 'D:\01 Project\Monthly Canadian job market analysis\canada-labour-market-sample-data.csv'
WITH (FORMAT CSV, HEADER);